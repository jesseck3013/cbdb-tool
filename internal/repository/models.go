...
type AddrCode struct {
	...
	CAdminCatCode int16    `json:"c_admin_cat_code"`
...
type AltnameCode struct {
	CNameTypeCode    int16   `json:"c_name_type_code"`
...
type AltnameDatum struct {
	...
	CAltNameTypeCode int16   `json:"c_alt_name_type_code"`
...
type AppointmentCode struct {
	CApptCode       int16   `json:"c_appt_code"`
...
type AssocCode struct {
	CAssocCode     int16   `json:"c_assoc_code"`
...
type AssocDatum struct {
	CAssocCode          int16   `json:"c_assoc_code"`
	CPersonid           int64   `json:"c_personid"`
	CKinCode            int16   `json:"c_kin_code"`
	CKinID              int64   `json:"c_kin_id"`
	CAssocID            int64   `json:"c_assoc_id"`
	CAssocKinCode       int16   `json:"c_assoc_kin_code"`
	...
	CAssocCount         int16   `json:"c_assoc_count"`
	CSequence           *int16  `json:"c_sequence"`
...
type BiogAddrCode struct {
	CAddrType             int16   `json:"c_addr_type"`
...
type BiogInstCode struct {
	CBiRoleCode int16   `json:"c_bi_role_code"`
...
type EntryCode struct {
	CEntryCode    int16  `json:"c_entry_code"`
...
type KinshipCode struct {
	CKincode          int16   `json:"c_kincode"`
	CKinPair1         int16   `json:"c_kin_pair1"`
	CKinPair2         int16   `json:"c_kin_pair2"`
	...
	CUpstep           int16   `json:"c_upstep"`
	CDwnstep          int16   `json:"c_dwnstep"`
	CMarstep          int16   `json:"c_marstep"`
	CColstep          int16   `json:"c_colstep"`
...
type StatusCode struct {
	CStatusCode    int16  `json:"c_status_code"`
